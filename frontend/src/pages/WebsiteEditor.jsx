    ...
    <div className="h-screen w-screen flex bg-black text-white overflow-hidden">
          ...
          <div className="p-3 border-t border-white/10">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 resize-none rounded-2xl px-4 py-3 bg-white/5 border border-white/10 text-white outline-none"
                value={prompt}
                onChange={(e) => setPrompt(e.target.value)}
                onKeyDown={(e) => e.key === "Enter" && handleUpdate()}
              />
              <button
                className="px-4 py-3 rounded-2xl bg-white text-black flex items-center justify-center"
      ...
      <AnimatePresence>
        {showCode && (
          ...
          >
            ...
            {/* Your code editor / content goes here */}
            <Editor
              theme="vs-dark"
              value={code}
              language="html"
      ...
      <AnimatePresence>
        {showFullPreview && (
          ...
          >
            {/* Top bar */}
            <div className="h-12 px-4 flex items-center justify-between bg-black border-b border-white/10">
              <span className="text-sm text-zinc-400">Live Preview</span>
              <button
                onClick={() => setFullPreview(false)}
                className="absolute top-4 right-4 p-2 bg-black rounded-lg"
              >
                <X size={18} />
              </button>
            </div>
