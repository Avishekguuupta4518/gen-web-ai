  ...
  return (
    <div className="relative min-h-screen bg-[#040404] text-white overflow-hidden">
              ...
              <div className="relative">
                ...
                >
                  <img
                    ...
                    alt=""
                    className="w-9 h-9 rounded-full border-white/20 object-cover"
                  />
                </button>
                <AnimatePresence>
                  {openProfile && (
      ...
      {userData && websites?.length > 0 && (
        <section className="max-w-7x1 mx-auto px-6 pb-32">
          <h3 className="text-2x1 font-semibold mb-6">Your Websites</h3>
