...
import { auth, provider } from "../firrebase";
        ...
        >
          ...
          >
            <div className="relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden">
              ...
              {/* Close button */}
              <button
                className="absolute top-5 right-5 z-20 text-zinc-400 text-lg hover:text-white transition"
                onClick={onClose}
              >
                x
              </button>
              ...
              <div className="relative px-8 pt-14 pb-10 text-center">
                ...
                <motion.button
                  ...
                  className="group relative w-full h-13 rounded-xl text-black font-semibold shadow-lg overflow-hidden bg-white"
                >
